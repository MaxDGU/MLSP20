...
# Get chord reduction
maxReps = 2 #run w 4 maxReps 
dictChord, listChord = chordUtil.getDictChord(eval(args.alpha))
dictKey, listKey = chordUtil.getDictKey() #this fn in chordUtil may need 2 b changed


#print(NewGroup.populateDict(4, NewGroup.newDict))
...
import pickle
u = "249"
with open("datasets/" + "a5_124_2" + "/train.pkl", 'rb') as pickle_file:
